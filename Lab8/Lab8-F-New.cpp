...
//            return -1;
//        }
//        if (k<=get_node_sub_size(node->left)){
...
//        ll pre,suc;
//        if (opt == 0){
//            pre = Adopters.get_Predecessor(val);
//            suc = Adopters.get_Successor(val);
...
//                }
//                ans+=abs(target-val);
//                Adopters.remove(target);
//            }
//        } else{
//            pre = Pets.get_Predecessor(val);
//            suc = Pets.get_Successor(val);
//            if (pre == -1e+10 && suc == 1e+10){
//                Adopters.add(val);
//            } else{
//                ll target;
